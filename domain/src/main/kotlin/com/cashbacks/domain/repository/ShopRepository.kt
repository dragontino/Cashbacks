...
interface ShopRepository {
    ...
    suspend fun updateShopsInCategory(categoryId: Long, shops: List<BasicInfoShop>): Result<Unit>

    suspend fun deleteShopsFromCategory(categoryId: Long, shops: List<BasicInfoShop>): Result<Unit>
